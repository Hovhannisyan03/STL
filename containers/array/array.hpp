...
{
    return const_iterator(const_cast<int*>(m_arr));
}

template <class T, size_t N>
typename my_std::array<T,N>::const_iterator my_std::array<T,N>::cend() const noexcept 
{
    return const_iterator(const_cast<int*>(m_arr + N));
}
...
// ======================================================== Iterator ========================================================
template <class T, size_t N>
my_std::array<T,N>::iterator::iterator(pointer ptr) : const_iterator(ptr) {}
...
template <class T, size_t N>
my_std::array<T,N>::const_reverse_iterator::const_reverse_iterator(pointer ptr) : m_ptr(ptr) {}
...
{
    return const_reverse_iterator(const_cast<int*>(m_arr + N - 1));
}

template <class T, size_t N>
typename my_std::array<T,N>::const_reverse_iterator my_std::array<T,N>::crend() const noexcept
{
    return const_reverse_iterator(const_cast<int*>(m_arr - 1));
}
...
template <class T, size_t N>
my_std::array<T,N>::reverse_iterator::reverse_iterator(pointer ptr) : const_reverse_iterator(ptr){}
