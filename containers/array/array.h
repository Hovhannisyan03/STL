...
template <class T, size_t N>
struct my_std::array<T,N>::const_iterator
{
...
template <class T, size_t N>
struct my_std::array<T,N>::iterator : public my_std::array<T,N>::const_iterator
{
        friend struct my_std::array<T,N>;
    private:
...
template <class T, size_t N>
struct my_std::array<T,N>::const_reverse_iterator
{
    friend struct my_std::array<T,N>;
    protected:
        pointer m_ptr; 
...
template <class T, size_t N>
struct my_std::array<T,N>::reverse_iterator : public my_std::array<T,N>::const_reverse_iterator
{
        friend struct my_std::array<T,N>;
    private:
